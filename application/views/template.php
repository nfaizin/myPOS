...
<div class="wrapper">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?=base_url()?>assets/dist/img/faiz.jpg" class="user-image">
              <span class="hidden-xs"><?=$this->fungsi->user_login()->username?></span>
            </a>
            <ul class="dropdown-menu">
              <li class="user-header">
                <img src="<?=base_url()?>assets/dist/img/faiz.jpg" class="img-circle">
  ...
  <div class="content-wrapper">
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2020 <a href="http://ios-nf.blogspot.com/">ZinTech</a>.</strong> All rights
        reserved.
      </footer>
